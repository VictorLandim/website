...
const resume = {
      ...
      content: [
        {
          ...
          time: "dec 2021",
          text: [
            "Researched natural language processing on undergraduate dissertation.",
          ],
        },
        {
          ...
          time: "jan 2020",
          text: [
            "Top student selected to participate in exchange program for a semester.",
          ],
        },
      ],
    },
  ...
  experiences: [
    ...
    },
    {
      ...
      description:
        "(Prominent Brazilian startup that connects students to private tutors)",
      content: [
...
const ResumePage = () => {
  ...
  const LinkMessage = () => (
    <div className="link-message">
      Coded with React -{" "}
      <a target="_blank" rel="noreferrer" href="https://victorlandim.com/cv">
        victorlandim.com/cv
      </a>
    </div>
  );
